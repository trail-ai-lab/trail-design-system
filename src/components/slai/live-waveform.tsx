...
/**
 * Real-time microphone waveform. Renders idle (a dotted line) until `active`,
 * then captures the mic via `getUserMedia` and animates a canvas waveform
 * from the live frequency data. Bar color defaults to the element's computed
 * text color, so set it with a semantic class (e.g. `text-primary`) rather
 * than the `barColor` prop.
 */
